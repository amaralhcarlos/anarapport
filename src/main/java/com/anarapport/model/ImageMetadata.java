 ...
 * clear "não informado"/estimated fallback rather than omitting them.
 */
public record ImageMetadata(int pixelWidth, int pixelHeight, Double horizontalDpi, Double verticalDpi,
                             double assumedDpiForEstimate, String colorMode, Integer bitsPerChannel,
                             String iccProfileName, String fileFormat, long fileSizeBytes, String fileName,
                             String filePath, Instant lastModified, ExifInfo exif) {
